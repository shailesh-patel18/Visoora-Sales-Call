  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-4">
        <div className="glass bg-zinc-950/80 backdrop-blur-xl border border-zinc-800/80 rounded-2xl px-6 py-4 flex items-center justify-between shadow-2xl relative">
          {/* Logo Brand */}
