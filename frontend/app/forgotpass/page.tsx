        ...
        <div className="glass rounded-2xl p-8 shadow-2xl border-[hsl(var(--border-default))] min-h-[280px] flex flex-col justify-center">
          {isSuccess ? (
            <div className="flex flex-col items-center justify-center text-center py-4 animate-pulse-live" style={{ animationDuration: "2.5s" }}>
              ...
              <p className="text-[13.5px] text-[hsl(var(--text-secondary))] max-w-[300px] mb-6">
                If the email <strong className="text-white">{email}</strong> matches an account, we have sent instructions to reset your password.
              </p>
              <Link
                href="/login"
            ...
            <>
              ...
              <p className="text-[13px] text-[hsl(var(--text-secondary))] mb-5 leading-relaxed">
                Enter your email address and we'll send you a recovery link to update your credentials.
              </p>
